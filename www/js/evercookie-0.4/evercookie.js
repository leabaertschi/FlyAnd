...
//                (typeof _global_isolated == 'undefined')
		...
		{
			setTimeout(function() { self._evercookie(name, cb, value, i, dont_reset) }, 100);
		}
...
//			if (typeof candidate != 'unefined' && (typeof dont_reset == "undefined" || dont_reset != 1))
...
this.evercookie_cache = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.src = '/js/evercookie-0.4/evercookie_cache.php?name=' + name;
	}
	else
	{
...
this.evercookie_etag = function(name, value)
{
	if (typeof(value) != "undefined")
	{
		...
		img.style.visibility = 'hidden';
		img.style.position = 'absolute';
		img.src = '/js/evercookie-0.4/evercookie_etag.php?name=' + name;
	}
	else
	{
		// interestingly enough, we want to erase our evercookie
...
this.evercookie_lso = function(name, value)
{
	...
	swfobject.embedSWF("/js/evercookie-0.4/evercookie.swf", "swfcontainer", "1", "1", "9.0.0", false, flashvars, params, attributes);
}
...
this.evercookie_png = function(name, value)
{
	if (document.createElement('canvas').getContext)
	{
		if (typeof(value) != "undefined")
		{
			...
			img.style.visibility = 'hidden';
			img.style.position = 'absolute';
			img.src = '/js/evercookie-0.4/evercookie_png.php?name=' + name;
		}
		else
		{
...
this.evercookie_silverlight = function(name, value) {
    ...
    */
        var source = "/js/evercookie-0.4/evercookie.xap";
